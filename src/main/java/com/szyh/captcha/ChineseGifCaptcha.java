...
import com.szyh.captcha.base.ChineseCaptchaAbstract;
import com.szyh.captcha.utils.GifEncoder;
...
public class ChineseGifCaptcha extends ChineseCaptchaAbstract {
    ...
    private BufferedImage graphicsImage(Color[] fontColor, char[] strs, int flag, int[][] besselXY) {
        ...
        for (int i = 0; i < strs.length; i++) {
            ...
            int fY =
                height - ((height - (int)fontMetrics.getStringBounds(String.valueOf(strs[i]), g2d).getHeight()) >> 1); // 文字的纵坐标
